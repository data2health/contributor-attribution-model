...
.. important:: **Terminological and Typographic Conventions in this Documentation**
          ...
          * We use the term '**data type**' to refer to more fundamental and general-purpose categories of data objects. These may include ‘simple’ data types (e.g. string, integer, identifier) that are represented as a single literal value, or ‘complex’ data types that are represented as objects with their own attributes (e.g. Coding). When referred to as modeling constructs in the text, complex data types are capitalized, but simple data types are not capitalized or otherwise distinguished.
          ...
          * Requirements speificatons are indicated by use of the capitalized keywords "MUST", "MUST NOT", "SHOULD", "SHOULD NOT", "MAY", “RECOMMENDED”, and “REQUIRED”, which are to be interpreted as described in `RFC 2119 <https://www.ietf.org/rfc/rfc2119.txt>`_. 
